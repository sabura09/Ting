...
// GET /api/admin/notifications/[id]/messages - Get conversation messages
export async function GET(
    ...
    try {
        ...
        console.error('Admin notification messages GET error:', error);
        return NextResponse.json({ error: 'Failed to fetch messages' }, { status: 500 });
    }
}

// POST /api/admin/notifications/[id]/messages - Admin sends a reply
export async function POST(
    ...
    try {
        ...
        console.error('Admin notification messages POST error:', error);
